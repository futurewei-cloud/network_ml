...
class clsModel:
    ...
    def pull_layer1(self, w1_arr):
        ...
        ###numapp = 0#
        ###dst = open(r'G:\Anaconda\1\data\results\layer1111.csv', 'w', newline="")
...
###packetSizeStd_s,packetSizeStd_r,packetSizeRange_s,packetSizeRange_r\n')
    ...
    def pull_layer2(self, w1_arr):
        ...
        ###numapp = 0
        ###dst = open(r'G:\Anaconda\1\data\results\layer22.csv', 'w', newline="")
    ...
    def pull_layer3(self, w1_arr):
        ...
        ###numapp = 0
        dst1 = open(r'G:\Anaconda\1\data\results\layer3_1.csv', 'w', newline="")
        dst1.write('pktsCount_s,pktsCount_r,packetSizeSum_s,packetSizeSum_r,flowsCount,hostsCount,FW_cluster_binary_encoding\n')
        dst2 = open(r'G:\Anaconda\1\data\results\layer3_2.csv', 'w', newline="")
        dst2.write('target\n')
        ...
        for clsWindow in w1_arr:
            ...
            ###if numapp < 2:
            dst1.write('{}\n'.format('\n'.join('%s' %i for i in data['x'])))
            dst2.write('{}\n'.format('\n'.join('%s' %i for i in data['y'])))
                ###numapp = numapp + 1
